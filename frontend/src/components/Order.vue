<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-actions>
            ...
            <v-dialog v-model="addToOrderDiagram" width="500">
                <AddToOrderCommand
                        @closeDialog="closeAddToOrder"
    ...
    export default {
        ...
        methods: {
            ...
            async addToOrder(params) {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['/orders/{orderId}'].href), params)
            ...
            openAddToOrder() {
                this.addToOrderDiagram = true;
            },
            closeAddToOrder() {
                this.addToOrderDiagram = false;
            },
        },
    }
</script>
